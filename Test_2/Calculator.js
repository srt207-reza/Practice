...
function checkIndex(temp){
    ...
    let isValid = false;
    if(document.getElementById("display").value != "" && document.getElementById("topdisplay").value == "" || document.getElementById("display").value == "" && document.getElementById("topdisplay").value != ""){
        if(temp == '+'){
    ...
    if(document.getElementById("display").value != "" && document.getElementById("topdisplay").value != ""){
        Tresult();
        document.getElementById("topdisplay").value += temp;
    }
